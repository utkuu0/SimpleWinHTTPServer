...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnStart->setGeometry(QRect(330, 90, 80, 24));
        btnStop = new QPushButton(centralwidget);
        btnStop->setObjectName("btnStop");
        btnStop->setEnabled(false);
        btnStop->setGeometry(QRect(330, 150, 80, 24));
        listClients = new QListWidget(centralwidget);
        listClients->setObjectName("listClients");
        listClients->setGeometry(QRect(220, 250, 311, 271));
